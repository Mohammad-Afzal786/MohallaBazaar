...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<CartResponseModel> addToCart(CartItemModel request) async {
    final _extra = <String, dynamic>{'requiresToken': false};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<CartCountModel> fetchCartCount(String userId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CartCountModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CartCountModel _value;
    try {
      _value = CartCountModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ViewCartResponse> getViewCart(String userId) async {
    final _extra = <String, dynamic>{'requiresToken': false};
    final queryParameters = <String, dynamic>{r'userId': userId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ViewCartResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ViewCartResponse _value;
    try {
      _value = ViewCartResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<OrderHistoryResponse> getOrderHistory(String userId) async {
    final _extra = <String, dynamic>{'requiresToken': false};
    final queryParameters = <String, dynamic>{r'userId': userId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HomeCategoryProductsResponse> getHomeCategoryProducts() async {
    final _extra = <String, dynamic>{'requiresToken': false};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HomeCategoryProductsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late HomeCategoryProductsResponse _value;
    try {
      _value = HomeCategoryProductsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ParentCategoryResponse> getParentCategories() async {
    final _extra = <String, dynamic>{'requiresToken': false};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ParentCategoryResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ParentCategoryResponse _value;
    try {
      _value = ParentCategoryResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
